...
squirrels <- readr::read_csv("./squirrels_fin.csv")
                ...
                fluidPage(
                    ...
                    fluidRow(
                        #insert video from file
                            ...
                            tags$video(src = "news-clip.mp4", width = "600px", height = "360px", type= "video/mp4", controls = "controls")
                    ),
            ...
            tabItem(
                ...
                fluidPage(
                    ...
                    fluidRow(
                        ...
                        #add in HTML embedded link for Google Trends
                        includeHTML("www/trends.html") ),
                    
                    h3("Heatmap Development"),
